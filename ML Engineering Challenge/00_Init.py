...
# MAGIC %sql
# MAGIC USE CATALOG cab_lakehouse;
# MAGIC
# MAGIC CREATE DATABASE IF NOT EXISTS cab_lakehouse.ml_sandbox;
...
file_path = f"/Volumes/cab_lakehouse/ml_sandbox/data/train.csv"
